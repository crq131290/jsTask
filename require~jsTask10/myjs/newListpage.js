//新增页依赖下面五个js文件
// 注意wangEditor,这里需要用它来进行实例化
define(['app','wangEditor','./constent','./filter','./directive'],function(app,wangEditor){     
    app.register.controller("newListpage",function($scope,$http,$state,$stateParams,types,industries,FileUploader) {
