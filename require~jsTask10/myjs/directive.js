//这里依赖bootstrap-datetimepicker来做时间插件
define(['app','../js/datetimepicker/bootstrap-datetimepicker'],function(app){      
  app.register   
  ...
  app.register.directive("uploadFile", function(FileUploader) {
    return {
      restrict: "E",
